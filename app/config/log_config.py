...
def set_log_obj():
    ...
    gun_logger_tuple = (logging.getLogger('uvicorn.error'), logging.getLogger('uvicorn.access'), logging.getLogger('sqlalchemy'), logging.getLogger('gunicorn.error'), logging.getLogger('gunicorn.access'))
